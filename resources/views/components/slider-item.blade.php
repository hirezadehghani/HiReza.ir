...
<div class="slider-item">
    ...
    <div class="container">
        ...
        <div class="one-third js-fullheight order-md-last img" style="background-image:url(@isset($image_url){{secure_asset('storage/' . $post->thumbnail)}} @else {{secure_asset('/images/1024-1024.png') }}'); @endisset);">
            <div class="overlay"></div>
        </div>
